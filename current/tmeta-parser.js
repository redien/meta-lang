...
parser.add("mark", function (input, offset, transform) {
    const parsed = [];
    const startOffset = offset;
...
parser.add("notNewlineOrMark", function (input, offset, transform) {
    const parsed = [];
    const startOffset = offset;
...
parser.add("notNewline", function (input, offset, transform) {
    ...
    parsed.push(parser.parse("notNewlineOrMark", input, offset, transform));
    if (parsed[parsed.length - 1] === null) { return null; }
    offset = parsed[parsed.length - 1].end;
...
parser.add("notNewline", function (input, offset, transform) {
    ...
    parsed.push(parser.parse("mark", input, offset, transform));
    if (parsed[parsed.length - 1] === null) { return null; }
    offset = parsed[parsed.length - 1].end;
...
parser.add("templatedText", function (input, offset, transform) {
    const parsed = [];
    const startOffset = offset;
    ...
    parsed.push(parser.parse("templatedText", input, offset, transform));
    if (parsed[parsed.length - 1] === null) { return null; }
    offset = parsed[parsed.length - 1].end;
    
    const parsedResults = parsed.map(function (p) { return p.result; });
    return {result: transform.templatedText_text.apply(null, parsedResults), start: startOffset, end: offset};
});
...
parser.add("templatedText", function (input, offset, transform) {
    ...
    const parsedResults = parsed.map(function (p) { return p.result; });
    return {result: transform.templatedText_mark.apply(null, parsedResults), start: startOffset, end: offset};
});
...
parser.add("templatedText", function (input, offset, transform) {
    ...
    const parsedResults = parsed.map(function (p) { return p.result; });
    return {result: transform.templatedText_none.apply(null, parsedResults), start: startOffset, end: offset};
});
